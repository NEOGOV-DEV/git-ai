...
```bash
curl -sSL https://raw.githubusercontent.com/ngv-dev/git-ai/refs/heads/main/install.sh | bash
```

Windows (non-WSL)

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -Command "irm https://raw.githubusercontent.com/ngv-dev/git-ai/refs/heads/main/install.ps1 | iex"
```
